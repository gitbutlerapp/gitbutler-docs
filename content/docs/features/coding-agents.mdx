...
You can access our agent management in the by clicking the AI Stars in the upper right corner of the GitButler window (NOTE: if there is already a session, the stars will appear above the commits. You can also find the AI stars on a branch header):
