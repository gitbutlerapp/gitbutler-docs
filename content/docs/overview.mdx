...
<Callout type="info">
  ...
  [integration branch](/features/branch-management/integration-branch) docs. We are working on
  making this interaction better.
</Callout>

## Target Branch

With parallel branches, you are not working off local main or master branches. Everything that you do is on a virtual branch, automatically.
