...
If the branch is the top of a stack, GitButler pushes the stack and creates missing reviews from the bottom upward. It also updates the stack metadata using native GitHub stacks when enabled and supported, or review descriptions on other forges.
