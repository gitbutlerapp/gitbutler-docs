...
you three ways to inspect and adjust that state: the [TUI](/gitbutler-tui),
the CLI, and the Desktop Client GUI. Use this page to pick the surface you
want. The detailed workflows live in their own docs.
